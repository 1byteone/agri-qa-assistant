...
| 项目 | Stars | 说明 |
|------|-------|------|
| [awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) | 143k+ | 最全开源提示词库，覆盖编程、写作、分�?|
| [Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | - | dair-ai 出品的系统化教程与论文合�?|
| [Learn Prompting](https://learnprompting.org) | - | 免费交互式提示工程课�?|
| [Awesome-LLM-Prompt-Libraries](https://github.com/danielrosehill/Awesome-LLM-Prompt-Libraries) | - | 面向开发者的提示词库聚合 |
| [OpenAI Cookbook](https://github.com/openai/openai-cookbook) | - | 官方示例代码与最佳实�?|
| [Anthropic Cookbook](https://platform.claude.com/cookbook) | - | Claude 专用模式�?Agent 实现 |
...
- [ ] 敏感信息（API Key、内部数据）已脱�?
- [ ] API 地址已更新为国内可用地址（如 `https://apihub.agnes-ai.cn/v1`�
